...
const Login = ({ navigation }: ScreenProps) => {
	...
	return <Container style={{ justifyContent: 'space-between' }}>
		...
		<View>
			...
			<Button onPress={() => navigation.navigate('Home')}>LOGIN TO YOUR ACCOUNT</Button>
			<Button onPress={() => navigation.navigate('ForgotPassword')} color="text" style={{ alignSelf: 'center' }} isTransparent>Forgot your password?</Button>
